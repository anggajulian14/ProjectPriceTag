...
class DataProdukAdapter(private val context: Context, private val dataList: MutableList<PricetagNormal>, private val jumlahDataTextView: TextView) :
    RecyclerView.Adapter<DataProdukAdapter.DataViewHolder>() {
